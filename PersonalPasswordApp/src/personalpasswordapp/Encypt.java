...
public class Encypt 
{
	 ...
	 */
	public Encypt(String password) throws GeneralSecurityException, UnsupportedEncodingException {
		this(false, password);
	}
	 ...
	 * @throws UnsupportedEncodingException if UTF-16 encoding is not supported.
	 */
	public Encypt(boolean debug, String password) throws GeneralSecurityException, UnsupportedEncodingException {
		try {
			DEBUG = debug;
	...
	public static void main(String[] args) {
		try {
			...
			Encypt aes = new Encypt(true, args[1]);
